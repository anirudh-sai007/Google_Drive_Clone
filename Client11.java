    ...
    public static void runClient(InetAddress IPAddress, int port) throws Exception {
        ...
        while (true) {
            ...
            if (command.startsWith("upload")) {
                ...
                // C:\\Users\\Aniruh\\OneDrive\\Desktop\\Project_Team10
String filename = command.substring(7);
File originalFile = new File("C:\\Users\\Aniruh\\OneDrive\\Desktop\\Project_Team10\\client\\" + filename);
File updatedFile = new File("C:\\Users\\Aniruh\\OneDrive\\Desktop\\Project_Team10\\client\\temp\\" + filename);
...
boolean clientFileDeleted2 = clientFile2.delete();
    ...
    if (serverFileDeleted && clientFileDeleted && clientFileDeleted2 ) {
